...
<html lang="en">
  <head>
    ...
    <title> Aplikasi Toko Pertanian Bejo </title>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="#"><i class="fa fa-desktop"></i> Data Pegawai <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.php?page=tampil_pegawai">Tampil Data</a></li>
                      <li><a href="index.php?page=tambah_pegawai">Tambah Data</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            Copyright @ 2021 Aplikasi Toko Pertanian Bejo
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
